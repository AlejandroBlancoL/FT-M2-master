...
// Tu código acá:
  let si = document.querySelector("#createdBy").innerHTML += "Alejandro";
...
function addToDo() {
  // Tu código acá:
  toDoItems.push(new ToDo(document.querySelector("#toDoInput").value));
...
function completeToDo(event) {
  ...
  //Tu código acá:
  // completeToDo[index] = completeToDo();
  // displayToDos();
